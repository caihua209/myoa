...
public class DateUtil2{
	 ...
	 * @return
	 */
	public static DateFormat getDateFormat(String fromat) {
		DateFormat dateFormat = null;
		if (StringUtils.isNotBlank(fromat)) {
			dateFormat = new SimpleDateFormat(fromat);
		} else {
	...
	public static String parseDateToStr(Date time, String timeFromat) {
		DateFormat dateFormat = getDateFormat(timeFromat);
	...
	public static String parseTimestampToStr(Timestamp timestamp, String timeFromat) {
		DateFormat df = getDateFormat(timeFromat);
	 ...
	 * @return yyyy-MM日期集合
	 */  
	public static List<String> listAllMonthsBetweenOfTwoDates(String beginDateStr, String endDateStr) {
		// 指定要解析的时间格式
		DateFormat f = getDateFormat("yyyy-MM");
		// 返回的月份列表
		String sRet = "";
     ...
     */  
	public static List<String> listAllDaysBetweenOfTwoDates(String beginDateStr, String endDateStr) {
		// 指定要解析的时间格式
		DateFormat f = getDefaultDateFormat();
		// 定义一些变量
		Date beginDate = null;
		Date endDate = null;
	 ...
	 * @return int 
	 */ 
    public static Integer getDayOfWeekNum(Date date){  
    	Calendar cal = Calendar.getInstance();  
    	cal.setTime(date);     
